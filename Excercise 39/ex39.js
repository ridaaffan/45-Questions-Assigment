"use strict";
//Q39: Album: Write a function called make_album() that builds a Object describing a music album. The function should take in an artist name and an album title, and it should return a Object containing these two pieces of information. 
...
const album1 = make_album('John', 'Pleasure');
const album2 = make_album('Hassan Ali', 'Jaanan', 4);
const album3 = make_album('Cheng', 'Ni how', 9);
console.log(album1);
console.log(album2);
console.log(album3);
