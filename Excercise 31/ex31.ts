...
let current_users : string[] = ['Rida' , 'Areeba', 'Ayesha', 'Syed Affan', 'Javeria'];

let new_users : string[] = ['Farrukh', 'Rasheda', 'AREEBA', 'ayesha', 'Jamil'];

function checkUserNames(current_users : string[], new_users: string[]) : void
{
    let lowercasedCurrentUsers : string[] = current_users.map(user => user.toLowerCase());
